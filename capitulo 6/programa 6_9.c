#include <stdio.h>
/* Asigna. El programa, al recibir un arreglo bidimensional cuadrado, asigna elementos en
...
/* Esta funcion se utiliza tanto para calcular el modulo entre el índice del arreglo unidimensional y 3, como para llamar a las funciones
